...
export default function LandingPage() {
  ...
  const features = [
    { 
      ...
      description: "Zarezerwuj samochód w kilka minut, odbierz gdy będziesz gotowy" 
    },
    { 
      icon: "🛡️", 
      title: "Pełne ubezpieczenie", 
      description: "Wszystkie nasze samochody posiadają kompleksowe ubezpieczenie" 
    },
    { 
      icon: "🔧", 
      title: "Wsparcie 24/7", 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex flex-col items-center md:items-start text-center md:text-left">
              <h1 className="text-4xl md:text-6xl font-bold leading-tight mb-6 text-white">
                Podróżuj stylowo z AutoRent
              </h1>
              <p className="text-white/80 text-lg mb-8 max-w-lg">
                Szeroka gama nowoczesnych pojazdów, konkurencyjne ceny, odbiór w dowolnej lokalizacji. Twoja przygoda zaczyna się tutaj!
              </p>
            ...
            <div className="hidden md:block relative">
              ...
              <div className="absolute bottom-10 left-10 bg-black/50 backdrop-blur-md p-4 rounded-xl border border-white/20 shadow-xl flex items-center space-x-2">
      ...
      <section className="relative py-12 bg-black/50 backdrop-blur-md">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">
            Gotowy do drogi? Zarezerwuj swój wymarzony samochód już teraz!
          </h2>
          <Link
            href="/rezerwacja"
